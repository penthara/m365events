...
const ModalAgenda = ({ modal, toggle, data }) => {
  ...
  return (
    <div>
      <Modal className="dec2021-agenda-dialog" isOpen={modal} toggle={toggle}>
            ...
            {data.speaker1Id != null ? (
              <div className="col">
                <img
                  ...
                  className="dec2021-speaker-img mb-3"
                  alt="speaker"
                />
                <p className="dec2021-speaker-name">
                  {
                    Speakers.filter((s) => s.speakerId === data.speaker1Id)[0]
                      .speakerName
                  }
