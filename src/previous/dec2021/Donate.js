...
export const Donate = () => {
  return (
    <div className="dec2021-donate">
      <div className="dec2021-donate-bg">
        <h1 className="dec2021-donate-heading"> SUPPORT A CAUSE </h1>
        <Row className="dec2021-donate-imgs">
          <Col xs={6} md={3} className="dec2021-donate-imgs1">
            <LazyLoad className="dec2021-dono-images" debounce={false}>
              <ImageLoader src={DonateImg1} alt="donate-imgs1" />
            </LazyLoad>
          </Col>
          <Col xs={6} md={3} className="dec2021-donate-imgs2">
            <LazyLoad className="dec2021-dono-images" debounce={false}>
              <ImageLoader src={DonateImg2} alt="donate-imgs2" />
            </LazyLoad>
          </Col>
          <Col xs={6} md={3} className="dec2021-donate-imgs3">
            <LazyLoad className="dec2021-dono-images" debounce={false}>
              <ImageLoader src={DonateImg3} alt="donate-imgs3" />
            </LazyLoad>
          </Col>
          <Col xs={6} md={3} className="dec2021-donate-imgs4">
            <LazyLoad className="dec2021-dono-images" debounce={false}>
              <ImageLoader src={DonateImg4} alt="donate-imgs4" />
            </LazyLoad>
          </Col>
        </Row>
        <div className="dec2021-donate-quote">
          <img
            src={OpenQuotes}
            alt="open-quotes"
            className="dec2021-open-quotes"
          />
          <span className="dec2021-donate-quote-span">Giving is Receiving</span>
          <img
            src={ClosedQuotes}
            alt="closed-quotes"
            className="dec2021-closed-quotes"
          />
        </div>
        <div className="dec2021-donate-para-text">
        ...
        <div className="dec2021-donation-btn">
          <div className="dec2021-donate-btn btn">
            <a
