...
export const Speaker = () => {
  ...
  return (
    <>
      <div className="dec2021-speakers" id="speakers">
        <h1 className="dec2021-speaker-heading text-center">Speakers</h1>
            ...
            return (
              <>
                {data.keynoteSpeaker === "false" && (
                  <div
                    className="col-xs-12 col-md-6 dec2021-speaker-card-wrapper col-xl-4"
                    key={data.speakerId}
                  >
                    <Card className="dec2021-speaker-card shadow nopadding">
                      <div className="dec2021-speaker-image">
                        <div id="dec2021-cube">
                      ...
                      <div
                        className="dec2021-card-title-wrapper"
                        onClick={() => toggle(data)}
                      >
                        <CardTitle
                          tag="h3"
                          className="dec2021-card-title text-center "
                        >
                          {data.speakerName}
                        </CardTitle>
                      </div>
                      <CardBody>
                        <div className="dec2021-cursor-click">
                          <CardSubtitle
                            onClick={() => toggle(data)}
                            tag="p"
                          ...
                          {data.MVPstatus === "true" ? (
                            <div>
                              <img
                                src={MVPlogo}
                                alt="MVP"
                                className="dec2021-card-socialmedia nopadding align-self-start dec2021-cursor-none"
                              />
                            </div>
                          ) : (
                            <></>
                          ...
                          {data.MicrosoftEmployee === "true" ? (
                            <div>
                              <img
                                ...
                                className="dec2021-card-socialmedia nopadding align-self-start"
                              />
                            </div>
                          ) : (
                            <></>
