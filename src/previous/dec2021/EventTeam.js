...
export const EventTeam = () => {
  return (
    <div className="dec2021-eventTeam" id="eventTeam">
      <h1 className="dec2021-eventTeam-heading">EVENT TEAM</h1>
      <h2 className="dec2021-event-organizers">Organizers</h2>
      <div className="row">
        {EventTeams.map((data) => {
          return (
            <>
              {data.isVolunteer === "false" ? (
                <div className="col">
                  <img
                    ...
                    className="dec2021-organizer-image"
                    alt="organizer"
                  />
                  <h4 className="dec2021-organizer-name">
                  ...
                  >
                    <img
                      src={LinkedInlogo}
                      alt="LinkedIn"
                      className="dec2021-card-linkedIn align-self-start"
                    />
                  </a>
                </div>
              ) : null}
      ...
      {EventTeams.filter((et) => et.isVolunteer === "true").length > 0 ? (
        <>
          <h2 className="dec2021-event-organizers">Volunteers</h2>
          <div className="row">
            {EventTeams.map((data) => {
              return (
                <>
