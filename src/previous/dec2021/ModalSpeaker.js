    ...
    <div>
      <Modal isOpen={modal} toggle={toggle}>
        ...
        <div className="nopadding">
          ...
          <div className="dec2021-bg-grey bg-grey dec2021-speaker-details">
            ...
            {CurrentSessions.length > 0
              ? CurrentSessions.map((sdata) => {
                  return (
                    <div className="dec2021-speaker-session-details">
                      <div className="dec2021-divider"></div>
                      <div className="dec2021-row row">
                        <div className="dec2021-modal-track-num col-4">
                          Track {sdata.trackId}
                        </div>
                        <div className="col-8 dec2021-speaker-session-time">
                          <span>{sdata.sessionTime}</span>
                        </div>
                      </div>
                      <div className="dec2021-speaker-session-title">
                        {sdata.sessionTitle}
                      </div>
                    </div>
                  );
